...
i=1  # overwrite @RRR
	# Make Boxplot
	png(file = paste(temp_currentdir, "boxplot-",colnames(Pheno_df)[i],".png", sep = ""),	width = s_width, height = s_height)
	...
	# Make PCA plot
	png(file = paste(temp_currentdir, "pca-",colnames(Pheno_df)[i],".png", sep = ""),	width = s_width, height = s_height)
		print(autoplot(temp_PCA,scale = T,col=Pheno_df[,i], main = paste("PCA of mydata;",colnames(Pheno_df)[i]))) 
	dev.off()
}

# Make Correlation plot
png(file = paste(temp_currentdir, "correlation plot.png", sep = ""),	width = s_width, height = s_height)
...
i=1  # overwrite @RRR
	# Make Boxplot
	png(file = paste(temp_currentdir, "boxplot-",colnames(Pheno_df)[i],"-normalized.png", sep = ""),	width = s_width, height = s_height)
	...
	# Make PCA plot
	png(file = paste(temp_currentdir, "pca-",colnames(Pheno_df)[i],"-normalized.png", sep = ""),	width = s_width, height = s_height)
		print(autoplot(temp_PCA,scale = T,col=Pheno_df[,i], main = paste("PCA of mydataNorm;",colnames(Pheno_df)[i]))) 
	dev.off()
}

# Make Correlation plot
png(file = paste(temp_currentdir, "correlation plot-normalized.png", sep = ""),	width = s_width, height = s_height)
